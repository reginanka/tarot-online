...
const tarotCards = [
    ...
    { id: 'm11', name: 'Справедливість', name_en: 'Justice', type_en: 'Major Arcana', image: IMG_BASE + 'm11.webp', meaning_upright: 'Говорить про те, що ви отримаєте те, на що заслуговуєте. Карта істини та відповідальності.', meaning_upright_en: 'Justice symbols fairness, truth, cause and effect, law.', meaning_reversed: 'Вказує на несправедливість, упередженість або спроби уникнути відповідальності.', meaning_reversed_en: 'Reversed: Injustice, lack of accountability, dishonesty.' },
